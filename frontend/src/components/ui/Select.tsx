  ...
  ({ label, error, helperText, options, children, className, id, required, ...props }, ref) => {
    ...
    return (
      <div className="w-full space-y-1.5">
        {label && (
          <label htmlFor={selectId} className="block text-sm font-semibold uppercase tracking-wider text-slate-700">
            {label}
        ...
        <div className="relative rounded-lg shadow-sm">
          <select
            ...
            className={twMerge(
              clsx(
                'block w-full appearance-none rounded-lg border bg-white py-2 pl-3 pr-10 text-base text-slate-900 transition-colors cursor-pointer',
