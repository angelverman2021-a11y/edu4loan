    ...
    <div className="min-h-[calc(100vh-4rem)] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="max-w-3xl space-y-3">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight flex items-center gap-3">
          ...
          <span>VIT Bhopal Education Loan Guide</span>
        </h1>
        <p className="text-base sm:text-base text-slate-600 leading-relaxed">
          Official B.Tech tuition fee tiers, hostel and boarding estimates, and standard operating procedures for securing your Bonafide Fee Certificate.
        </p>
      </div>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <Card className="border-slate-200 shadow-sm overflow-hidden">
            <CardHeader className="bg-slate-50 border-b border-slate-200 py-3.5">
              <CardTitle className="text-base sm:text-base font-bold text-slate-900">
            ...
            <CardContent className="p-4 space-y-3 text-sm">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200">
                  ...
                  <span className="text-brand-800 font-bold block text-base">~₹1,15,000 / yr</span>
                ...
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200">
                  ...
                  <span className="text-brand-800 font-bold block text-base">~₹1,55,000 / yr</span>
                ...
                <div className="p-3 rounded-lg bg-slate-50 border border-slate-200">
                  ...
                  <span className="text-slate-900 font-extrabold block text-base">₹4.6L – ₹6.2L</span>
          ...
          <Card className="border-slate-200 shadow-sm">
            <CardHeader className="py-3.5 bg-slate-50 border-b border-slate-100">
              ...
              <p className="text-sm text-slate-500">Step-by-step procedure for bank submission.</p>
            </CardHeader>
            <CardContent className="space-y-3 text-sm text-slate-600 pt-4">
            ...
            <CardContent className="space-y-3 text-sm text-slate-600 pt-4">
              ...
              <div className="space-y-2">
                <div className="p-3 bg-slate-50 rounded-lg border border-slate-200 space-y-1">
                  ...
                  <p className="font-mono text-sm font-semibold text-brand-800">VIT Bhopal University</p>
                  <p className="text-xs text-slate-500">Payable at: Bhopal / Ashta Branch</p>
                </div>
                <div className="p-3 bg-slate-50 rounded-lg border border-slate-200 space-y-1">
        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="border-slate-200 shadow-sm">
            <CardHeader className="py-3.5 bg-slate-50 border-b border-slate-100">
              ...
              <p className="text-sm text-slate-500">Branches handling VIT Bhopal student loans.</p>
            </CardHeader>
